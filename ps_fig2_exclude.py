...
def mean_score_per_attempt(num_attempts, num_attempt_limit, maxscores, first_20_scores):
    ...
    played_less_than = pb.array(num_attempts) < 101
...
if makefig:
    ...
    plt.xlim([0.5, 20.5])
    plt.ylim([-7000,49000])
    plt.savefig('StaffordFig2exclude.png', dpi=300, facecolor='w', edgecolor='w',
            orientation='portrait', papertype=None, format=None,
            transparent=False, bbox_inches=None, pad_inches=0.1)
    
    generatepaperfigs=0
    if generatepaperfigs:    
        plt.savefig('../psycscience/StaffordFig2exclude.png', dpi=300, facecolor='w', edgecolor='w',
            orientation='portrait', papertype=None, format=None,
            transparent=False, bbox_inches=None, pad_inches=0.1)
