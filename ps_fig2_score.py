...
if makefig:
    ...
    mean_agg_score_at_attempt_i_for_percentile_j=pickle.load(open('save_mean_agg_score_at_attempt_i_for_percentile_j.p', 'rb'))    
    ...
    #plt.xlim([0.5, 75020.5])
    #plt.ylim([-7000,49000])
    plt.savefig('StaffordFig2score.png', dpi=300, facecolor='w', edgecolor='w',
            orientation='portrait', papertype=None, format=None,
            transparent=False, bbox_inches=None, pad_inches=0.1)
    
    generatepaperfigs=0
    if generatepaperfigs:    
        plt.savefig('../psycscience/StaffordFig2score.png', dpi=300, facecolor='w', edgecolor='w',
            orientation='portrait', papertype=None, format=None,
            transparent=False, bbox_inches=None, pad_inches=0.1)
