...
#now for each key wSeacoleeimport scipy.stats.mstats as ssm want to plot the value in decile against 
...
#now I have to normSeacolealise for amount of time spent playing
...
maxscore_boot={}
for key in big:
    maxscore_boot[key]=max(random.sample(a,len(big[key])))
