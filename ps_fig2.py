...
def mean_score_per_attempt(num_attempts, num_attempt_limit, maxscores, first_20_scores):
    ...
    # this mask means we exlude players with very high number of plays
    played_less_than = pb.array(num_attempts) < 100000 #ie don't exclude anyone on this criterion 101 is a sensible number, this 
    
    
    eligible_mask = played_more_than & played_less_than
...
if makefig:
    ...
    plt.xlim([0.5, 20.5])
    plt.ylim([-7000,49000])
    plt.savefig('StaffordFig2.png', dpi=300, facecolor='w', edgecolor='w',
            orientation='portrait', papertype=None, format=None,
            transparent=False, bbox_inches=None, pad_inches=0.1)
    
    generatepaperfigs=1
    if generatepaperfigs:    
        plt.savefig('../psychscience/StaffordFig2.pdf', dpi=300, facecolor='w', edgecolor='w',
            orientation='portrait', papertype=None, format=None,
            transparent=False, bbox_inches=None, pad_inches=0.1)
